...
// User
    ...
    public async Task<Response<TrackInfo>> SearchTrackAsync(string searchQuery)
    {
        ...
        LastFmStatistics.LastfmApiCalls.WithLabels("track.search").Inc();
    ...
    public async Task<Response<AlbumInfo>> SearchAlbumAsync(string searchQuery)
    {
        ...
        LastFmStatistics.LastfmApiCalls.WithLabels("album.search").Inc();
        ...
        try
        {
            ...
            if (useCache)
            {
                    ...
                    topAlbumResponse.TopAlbums.Count >= count)
                {
                    ...
                    {
                        Content = topAlbumResponse with { TopAlbums = topAlbumResponse.TopAlbums.Take(count).ToList() },
                        Success = true
                    };
                }
            }
        ...
        try
        {
            ...
            if (useCache)
            {
                    ...
                    topArtistResponse.TopArtists.Count >= count)
                {
                    ...
                    {
                        Content = topArtistResponse with
                        {
        ...
        try
        {
            ...
            if (useCache)
            {
                    ...
                    topTrackResponse.TopTracks.Count >= count)
                {
                    ...
                    {
                        Content = topTrackResponse with { TopTracks = topTrackResponse.TopTracks.Take(count).ToList() },
                        Success = true
                    };
                }
            }
