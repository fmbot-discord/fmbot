...
namespace FMBot.Persistence.EntityFrameWork.Migrations
{
    ...
    [Migration("20260914193751_AddDeezerData")]
    partial class AddDeezerData
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FMBot.Persistence.Domain.Models.Album", b =>
                {
                    ...
                    b.Property<DateTime?>("AiDescriptionDate")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("ai_description_date");

                    b.Property<string>("AiDescriptionHash")
                        .HasColumnType("text")
                        .HasColumnName("ai_description_hash");
                    ...
                    b.Property<DateTime?>("DeezerDate")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("deezer_date");

                    b.Property<long?>("DeezerId")
                        .HasColumnType("bigint")
                        .HasColumnName("deezer_id");
            ...
            modelBuilder.Entity("FMBot.Persistence.Domain.Models.AlbumGenre", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int?>("SourceGenreId")
                        .HasColumnType("integer")
                        .HasColumnName("source_genre_id");

                    b.HasKey("Id")
                        .HasName("pk_album_genres");

                    b.HasIndex("AlbumId", "Source", "Name")
                        .IsUnique()
                        .HasDatabaseName("ix_album_genres_album_id_source_name");
            ...
            modelBuilder.Entity("FMBot.Persistence.Domain.Models.AlbumTag", b =>
                {
                    b.Property<int>("AlbumId")
                        .HasColumnType("integer")
                        .HasColumnName("album_id");
                    ...
                    b.HasKey("AlbumId", "TagId")
                        .HasName("pk_album_tags");

                    b.HasIndex("TagId")
                        .HasDatabaseName("ix_album_tags_tag_id");
            ...
            modelBuilder.Entity("FMBot.Persistence.Domain.Models.ArtistTag", b =>
                {
                    b.Property<int>("ArtistId")
                        .HasColumnType("integer")
                        .HasColumnName("artist_id");
                    ...
                    b.HasIndex("TagId")
                        .HasDatabaseName("ix_artist_tags_tag_id");
            ...
            modelBuilder.Entity("FMBot.Persistence.Domain.Models.Channel", b =>
                {
                    ...
                    b.PrimitiveCollection<decimal[]>("RecommendedAlternativeChannelIds")
                        .HasColumnType("numeric(20,0)[]")
                        .HasColumnName("recommended_alternative_channel_ids");
            ...
            modelBuilder.Entity("FMBot.Persistence.Domain.Models.Friend", b =>
                {
                    ...
                    b.Property<bool>("LastFmFriend")
                        .HasColumnType("boolean")
                        .HasColumnName("last_fm_friend");
            ...
            modelBuilder.Entity("FMBot.Persistence.Domain.Models.Guild", b =>
                {
                    ...
                    b.Property<int?>("FeaturedFrequency")
                        .HasColumnType("integer")
                        .HasColumnName("featured_frequency");
                    ...
                    b.Property<DateTime?>("LastRecap")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("last_recap");
                    ...
                    b.Property<decimal?>("RecapChannelId")
                        .HasColumnType("numeric(20,0)")
                        .HasColumnName("recap_channel_id");

                    b.Property<int?>("RecapSchedule")
                        .HasColumnType("integer")
                        .HasColumnName("recap_schedule");
            ...
            modelBuilder.Entity("FMBot.Persistence.Domain.Models.GuildAutopost", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<string>("ArtistFilter")
                        .HasColumnType("text")
                        .HasColumnName("artist_filter");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_guild_autoposts");

                    b.HasIndex("ChannelId")
                        .HasDatabaseName("ix_guild_autoposts_channel_id");

                    b.HasIndex("GuildId")
                        .HasDatabaseName("ix_guild_autoposts_guild_id");

                    b.ToTable("guild_autoposts", (string)null);
                });

            modelBuilder.Entity("FMBot.Persistence.Domain.Models.GuildAutopostRun", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<int>("AutopostId")
                        .HasColumnType("integer")
                        .HasColumnName("autopost_id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_guild_autopost_runs");

                    b.HasIndex("AutopostId")
                        .HasDatabaseName("ix_guild_autopost_runs_autopost_id");

                    b.ToTable("guild_autopost_runs", (string)null);
                });
            ...
            modelBuilder.Entity("FMBot.Persistence.Domain.Models.GuildFeaturedLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_guild_featured_logs");

                    b.HasIndex("GuildId", "DateTime")
                        .HasDatabaseName("ix_guild_featured_logs_guild_id_date_time");

                    b.ToTable("guild_featured_logs", (string)null);
                });

            modelBuilder.Entity("FMBot.Persistence.Domain.Models.GuildShortcut", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_guild_shortcuts");

                    b.HasIndex("GuildId")
                        .HasDatabaseName("ix_guild_shortcuts_guild_id");

                    b.ToTable("guild_shortcuts", (string)null);
                });
            ...
            modelBuilder.Entity("FMBot.Persistence.Domain.Models.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<string>("NormalizedName")
                        ...
                        .HasComputedColumnSql("tag_normalize(name::text)", true);
            ...
            modelBuilder.Entity("FMBot.Persistence.Domain.Models.TrackTag", b =>
                {
                    b.Property<int>("TrackId")
                        .HasColumnType("integer")
                        .HasColumnName("track_id");
            ...
            modelBuilder.Entity("FMBot.Persistence.Domain.Models.User", b =>
                {
                    ...
                    b.Property<bool?>("CorrectionsDisabled")
                        .HasColumnType("boolean")
                        .HasColumnName("corrections_disabled");
                    ...
                    b.Property<int?>("GraphColor")
                        .HasColumnType("integer")
                        .HasColumnName("graph_color");

                    b.Property<string>("GraphCustomColor")
                        .HasColumnType("text")
                        .HasColumnName("graph_custom_color");
                    ...
                    b.Property<DateTime?>("SpotifyConnectionExpiry")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("spotify_connection_expiry");

                    b.Property<DateTime?>("SpotifyExpiryChecked")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("spotify_expiry_checked");
                    ...
                    b.Property<int?>("WhoKnowsMode")
                        .HasColumnType("integer")
                        .HasColumnName("who_knows_mode");
            ...
            modelBuilder.Entity("FMBot.Persistence.Domain.Models.UserDmNotification", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_user_dm_notifications");

                    b.HasIndex("DiscordUserId")
                        .HasDatabaseName("ix_user_dm_notifications_discord_user_id");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_user_dm_notifications_user_id");

                    b.ToTable("user_dm_notifications", (string)null);
                });

            modelBuilder.Entity("FMBot.Persistence.Domain.Models.UserFmSetting", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("integer")
                        .HasColumnName("user_id");
                    ...
                    b.Property<long>("FooterOptions")
                        .HasColumnType("bigint")
                        .HasColumnName("footer_options");

                    b.Property<DateTime?>("Modified")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("modified");

                    b.Property<bool?>("PrivateButtonResponse")
                        .HasColumnType("boolean")
                        .HasColumnName("private_button_response");

                    b.Property<int?>("SmallTextType")
                        .HasColumnType("integer")
                        .HasColumnName("small_text_type");

                    b.HasKey("UserId")
                        .HasName("pk_user_fm_settings");

                    b.ToTable("user_fm_settings", (string)null);
                });
            ...
            modelBuilder.Entity("FMBot.Persistence.Domain.Models.UserInteraction", b =>
                {
                    ...
                    b.Property<decimal?>("HostMessageId")
                        .HasColumnType("numeric(20,0)")
                        .HasColumnName("host_message_id");
            ...
            modelBuilder.Entity("FMBot.Persistence.Domain.Models.UserShortcut", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_user_shortcuts");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_user_shortcuts_user_id");

                    b.ToTable("user_shortcuts", (string)null);
                });
            ...
            modelBuilder.Entity("FMBot.Persistence.Domain.Models.UserStreak", b =>
                {
                    ...
                    b.Property<string>("GenreStreaks")
                        .HasColumnType("jsonb")
                        .HasColumnName("genre_streaks");
            ...
            modelBuilder.Entity("Shared.Domain.Models.PremiumGuildSubscription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<decimal?>("DiscordEntitlementId")
                        .HasColumnType("numeric(20,0)")
                        .HasColumnName("discord_entitlement_id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_premium_guild_subscriptions");

                    b.HasIndex("DiscordEntitlementId")
                        .IsUnique()
                        .HasDatabaseName("ix_premium_guild_subscriptions_discord_entitlement_id");

                    b.HasIndex("DiscordGuildId")
                        .HasDatabaseName("ix_premium_guild_subscriptions_discord_guild_id");

                    b.HasIndex("StripeSubscriptionId")
                        .IsUnique()
                        .HasDatabaseName("ix_premium_guild_subscriptions_stripe_subscription_id");

                    b.ToTable("premium_guild_subscriptions", (string)null);
                });
            ...
            modelBuilder.Entity("FMBot.Persistence.Domain.Models.AlbumTag", b =>
                {
                    b.HasOne("FMBot.Persistence.Domain.Models.Album", "Album")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_album_tags_albums_album_id");

                    b.HasOne("FMBot.Persistence.Domain.Models.Tag", "Tag")
                        .WithMany("AlbumTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_album_tags_tags_tag_id");
            ...
            modelBuilder.Entity("FMBot.Persistence.Domain.Models.ArtistTag", b =>
                {
                    ...
                    b.HasOne("FMBot.Persistence.Domain.Models.Tag", "Tag")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_artist_tags_tags_tag_id");
            ...
            modelBuilder.Entity("FMBot.Persistence.Domain.Models.GuildAutopost", b =>
                {
                    b.HasOne("FMBot.Persistence.Domain.Models.Guild", "Guild")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_guild_autoposts_guilds_guild_id");
            ...
            modelBuilder.Entity("FMBot.Persistence.Domain.Models.GuildAutopostRun", b =>
                {
                    b.HasOne("FMBot.Persistence.Domain.Models.GuildAutopost", "Autopost")
                        .WithMany("Runs")
                        .HasForeignKey("AutopostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_guild_autopost_runs_guild_autoposts_autopost_id");

                    b.Navigation("Autopost");
                });
            ...
            modelBuilder.Entity("FMBot.Persistence.Domain.Models.GuildFeaturedLog", b =>
                {
                    b.HasOne("FMBot.Persistence.Domain.Models.Guild", "Guild")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_guild_featured_logs_guilds_guild_id");
            ...
            modelBuilder.Entity("FMBot.Persistence.Domain.Models.GuildShortcut", b =>
                {
                    b.HasOne("FMBot.Persistence.Domain.Models.Guild", "Guild")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_guild_shortcuts_guilds_guild_id");
            ...
            modelBuilder.Entity("FMBot.Persistence.Domain.Models.UserDmNotification", b =>
                {
                    b.HasOne("FMBot.Persistence.Domain.Models.User", "User")
                        .WithMany("DmNotifications")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_user_dm_notifications_users_user_id");
            ...
            modelBuilder.Entity("FMBot.Persistence.Domain.Models.UserFmSetting", b =>
                {
                    b.HasOne("FMBot.Persistence.Domain.Models.User", "User")
                        .WithOne("FmSetting")
                        .HasForeignKey("FMBot.Persistence.Domain.Models.UserFmSetting", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_user_fm_settings_users_user_id");
            ...
            modelBuilder.Entity("FMBot.Persistence.Domain.Models.UserShortcut", b =>
                {
                    b.HasOne("FMBot.Persistence.Domain.Models.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_user_shortcuts_users_user_id");
            ...
            modelBuilder.Entity("FMBot.Persistence.Domain.Models.User", b =>
                {
                    ...
                    b.Navigation("DmNotifications");

                    b.Navigation("FeaturedLogs");

                    b.Navigation("FmSetting");
