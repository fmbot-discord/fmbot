...
namespace FMBot.Persistence.EntityFrameWork.Migrations
{
    ...
    [Migration("20221119211755_AddDiscogsRelation")]
    partial class AddDiscogsRelation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FMBot.Persistence.Domain.Models.DiscogsGenre", b =>
                {
                    ...
                    b.HasIndex("MasterId")
                        .HasDatabaseName("ix_discogs_genre_master_id");

                    b.ToTable("discogs_genre", (string)null);
                });

            modelBuilder.Entity("FMBot.Persistence.Domain.Models.DiscogsMaster", b =>
                {
            ...
            modelBuilder.Entity("FMBot.Persistence.Domain.Models.DiscogsStyle", b =>
                {
                    ...
                    b.HasIndex("MasterId")
                        .HasDatabaseName("ix_discogs_style_master_id");
            ...
            modelBuilder.Entity("FMBot.Persistence.Domain.Models.UserDiscogsReleases", b =>
                {
                    ...
                    b.Property<int?>("UserDiscogsUserId")
                        .HasColumnType("integer")
                        .HasColumnName("user_discogs_user_id");
                    ...
                    b.HasIndex("UserDiscogsUserId")
                        .HasDatabaseName("ix_user_discogs_releases_user_discogs_user_id");
            ...
            modelBuilder.Entity("FMBot.Persistence.Domain.Models.DiscogsGenre", b =>
                {
                    b.HasOne("FMBot.Persistence.Domain.Models.DiscogsMaster", "DiscogsMaster")
                        .WithMany("Genres")
            ...
            modelBuilder.Entity("FMBot.Persistence.Domain.Models.UserDiscogsReleases", b =>
                {
                    ...
                    b.HasOne("FMBot.Persistence.Domain.Models.UserDiscogs", null)
                        .WithMany("Releases")
                        .HasForeignKey("UserDiscogsUserId")
                        .HasConstraintName("fk_user_discogs_releases_user_discogs_user_discogs_temp_id1");
