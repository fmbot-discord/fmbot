...
namespace FMBot.Persistence.EntityFrameWork.Migrations
{
    ...
    [Migration("20201119124905_AddChannelsAndCrowns")]
    partial class AddChannelsAndCrowns
    {
            ...
            modelBuilder.Entity("FMBot.Persistence.Domain.Models.UserCrown", b =>
                {
                    ...
                    b.HasKey("CrownId")
                        .HasName("pk_user_crown");

                    b.HasIndex("GuildId")
                        .HasDatabaseName("ix_user_crown_guild_id");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_user_crown_user_id");

                    b.ToTable("user_crown");
                });
            ...
            modelBuilder.Entity("FMBot.Persistence.Domain.Models.UserCrown", b =>
                {
                    b.HasOne("FMBot.Persistence.Domain.Models.Guild", "Guild")
                        ...
                        .HasForeignKey("GuildId")
                        .HasConstraintName("fk_user_crown_guilds_guild_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.HasOne("FMBot.Persistence.Domain.Models.User", "User")
                        .WithMany("Crowns")
                        .HasForeignKey("UserId")
                        .HasConstraintName("fk_user_crown_users_user_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
